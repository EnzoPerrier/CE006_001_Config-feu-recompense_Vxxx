...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN5
    */
    GPIO_InitStruct.Pin = V_BATT_Pin|V_ALIM_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, V_BATT_Pin|V_ALIM_Pin);
...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  */
    ...
    PeriphClkInit.Lptim3ClockSelection = RCC_LPTIM3CLKSOURCE_PCLK1;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInit) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    PB8     ------> LPTIM3_IN2
    */
    GPIO_InitStruct.Pin = ENCOD_A_Pin|ENCOD_B_Pin;
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* hlptim)
{
  if(hlptim->Instance==LPTIM3)
  {
    ...
    PB8     ------> LPTIM3_IN2
    */
    HAL_GPIO_DeInit(GPIOB, ENCOD_A_Pin|ENCOD_B_Pin);
